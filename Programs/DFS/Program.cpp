...
void test_DFS_01()
{
    ...
    //GraphAdjListEx<BaseEdge<>, NotWeighted> graph(NotDirected);
    GraphAdjMatrixEx<BaseEdge<>, NotWeighted> graph(NotDirected);
...
void test_DFS_02()
{
    ...
    // graph with 8 nodes (vertices)
    //GraphAdjListEx<BaseEdge<>, NotWeighted> graph(Directed);
    GraphAdjMatrixEx<BaseEdge<>, NotWeighted> graph(Directed);
